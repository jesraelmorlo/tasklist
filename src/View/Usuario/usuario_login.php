...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo URL;?>">
    <img style="height: 110px;" src="<?php echo URL;?>images/logo_default.jpg" /> <br>
    <b>
		<h4>Tasklist</h4>
    </a>
  </div>
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo URL;?>Usuario/index/" method="post">
		<?php  
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="usuario" autofocus placeholder="Usuário ou E-mail">
    ...
    <a href="<?php echo URL;?>Usuario/cadastrarNovoUsuario/">Cadastrar-me</a><br>
